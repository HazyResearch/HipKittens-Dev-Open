```
root@gpu-10:/workdir/AMD-benchmarking-harness/kernels/TK/gemm/bf16fp32/mi325x/1024_256_256_64_16# make
/opt/rocm/bin/hipcc 256_256_64_16.cpp -DKITTENS_CDNA3 --offload-arch=gfx942 -std=c++20 -w -I/workdir/AMD-benchmarking-harness/ThunderKittens-HIP/include -I/workdir/AMD-benchmarking-harness/ThunderKittens-HIP/prototype -I/opt/conda/envs/py_3.12/include/python3.12 -I/opt/conda/envs/py_3.12/lib/python3.12/site-packages/pybind11/include -L/opt/conda/envs/py_3.12/lib/python3.12/config-3.12-x86_64-linux-gnu -L/opt/conda/envs/py_3.12/lib  -lpthread -ldl  -lutil -lm  -shared -fPIC -Rpass-analysis=kernel-resource-usage -I/workdir/AMD-benchmarking-harness/ThunderKittens-HIP/include -I/opt/rocm/include/hip  \
    -o tk_kernel.cpython-312-x86_64-linux-gnu.so 2>&1 | tee /workdir/data_logs/0716_000657_outputs/make_build.log
...
256_256_64_16.cpp:38:1: remark:     VGPRs: 214 [-Rpass-analysis=kernel-resource-usage]
...
256_256_64_16.cpp:38:1: remark:     Occupancy [waves/SIMD]: 2 [-Rpass-analysis=kernel-resource-usage]
...
root@gpu-10:/workdir/AMD-benchmarking-harness/kernels/TK/gemm/bf16fp32/mi325x/1024_256_256_64_16# python test_python.py
src: 256_256_64_16.cpp
Warning: tk_kernel.cpython-313-x86_64-linux-gnu.so not found at /workdir/AMD-benchmarking-harness/kernels/TK/gemm/bf16fp32/mi325x/1024_256_256_64_16/tk_kernel.cpython-313-x86_64-linux-gnu.so, skipping.
C_ref.dtype=torch.bfloat16
PyTorch reference average execution time: 0.0258 ms
PyTorch reference performance: 83.12 TFLOPS for 1024x1024 matrix multiplication.

C.dtype=torch.bfloat16
Average execution time: 0.0292 ms
Performance: 73.46 TFLOPS for 1024x1024 matrix multiplication.

Max error between kernel and reference: 0.0078125
Max error: 0.0078125
Mean error: 0.000715533213224262
Number of large errors (>0.1): 0

diff[:32, :32].max() tensor(0.0078, device='cuda:0')
diff[:32, 32:64].max() tensor(0.0078, device='cuda:0')
diff[32:64, :32].max() tensor(0.0039, device='cuda:0')
diff[32:64, 32:64].max() tensor(0.0039, device='cuda:0')
```