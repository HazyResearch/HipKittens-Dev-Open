...
__global__ void attend_ker(const attn_globals<D> g) {
    ...
    prefill_swizzled_offsets<1, false, st_bf<KV_BLOCK_SIZE, ATTN_D, ducks::st_layout::row>, _gl_QKVO, coord<st_bf<KV_BLOCK_SIZE,ATTN_D, ducks::st_layout::row>>, NUM_THREADS>(
        g.Kg, {batch_idx, 0, head_idx_kv, 0}, k_smem[0], swizzled_offsets_K);
    prefill_swizzled_offsets<1, false, st_bf<KV_BLOCK_SIZE, ATTN_D, ducks::st_layout::accumulator>, _gl_QKVO, coord<st_bf<KV_BLOCK_SIZE,ATTN_D, ducks::st_layout::accumulator>>, NUM_THREADS>(
