 ...
 */
#ifdef KITTENS_CDNA4
template<ducks::rt_layout::all layout1, ducks::rt_matrix::all matrix_layout1, typename T, int _height, int _width, ducks::rt_layout::all layout2, ducks::rt_matrix::all matrix_layout2>
__device__ static inline void swap_layout(rt<T, _height, _width, layout1, matrix_layout1> &dst, const rt<T, _height, _width, layout2, matrix_layout2> &src) {
